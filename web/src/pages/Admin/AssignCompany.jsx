...
const Page = () => {
    ...
    const { request: studentRequest, loading: studentLoading, data: studentData, error } = useAPI(studentsAPI.getByStudentId, { errorMessage: "Could not load student information", onComplete: ({ department }) => { companyRequest(department) } });
