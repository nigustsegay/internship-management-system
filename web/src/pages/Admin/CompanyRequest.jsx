        ...
        {data && <>
            ...
            >
                ...
                <StyledBody>
                    ...
                    <ListItem>
                        <ListItemLabel description="Number of Interns">{data.documentOfIntent}</ListItemLabel>
                    </ListItem>
                    <ListItem>
                    ...
                    <ListItem>
                        <ListItemLabel ><Button kind="secondary" onClick={() => { window.open(data.documentOfIntent, '_blank').focus(); }}>View Legal Document</Button></ListItemLabel>
                    </ListItem>
