...
const Page = () => {
    ...
    const studentActions = (data) => {
        ...
        if (data && data.internship && !data.internship.company) {
            actions.push({ name: "Assign to Company", link: `/app/admin/assign-company/${studentId}` })
        }
        if (data && data.internship && !data.internship.advisor) {
            actions.push({ name: "Assign Advisor", link: `/app/admin/assign-advisor/${studentId}` })
        }
        return actions;
    }
